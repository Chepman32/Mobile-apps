...
const SettingsScreen = () => {
  const resetData = () => {
    Alert.alert(
      'Reset All Data',
      'Are you sure you want to reset all health risk data? This cannot be undone.',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Reset', onPress: () => {
            // Placeholder for clearing SQLite data and AsyncStorage
            Alert.alert('Data Reset', 'All health risk data has been reset (conceptual).');
          }
        },
      ],
      { cancelable: true }
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.settingButton} onPress={resetData}>
        <Text style={styles.settingButtonText}>Reset All Risk Data</Text>
      </TouchableOpacity>
