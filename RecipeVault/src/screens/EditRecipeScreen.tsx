...
const EditRecipeScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (foundRecipe) {
      ...
      setSelectedCuisine(foundRecipe.cuisine?.id || null);
      setSelectedCategory(foundRecipe.category?.id || null);
      setTags(foundRecipe.tags || []);
      setIngredients(foundRecipe.ingredients || []);
      setInstructions(foundRecipe.instructions || []);
      setNutrition(foundRecipe.nutrition || {
        calories: 0,
        protein: 0,
        carbs: 0,
        fat: 0,
  ...
  const handleSaveRecipe = async () => {
    ...
    try {
      ...
      await actions.updateRecipe(updatedRecipe);
