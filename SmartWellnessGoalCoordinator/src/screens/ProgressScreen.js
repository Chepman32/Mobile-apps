...
const ProgressScreen = ({ route }) => {
        ...
        () => {
          ...
          tx.executeSql(
            ...
            (_, { rows }) => {
              if (rows.length === 0) {
                const dummyProgress = [
                  { date: '2024-07-01', progress: 1 },
                  { date: '2024-07-05', progress: 2 },
                  { date: '2024-07-10', progress: 3 },
                ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.infoText}>Advanced coordination and wellness coaching available with Premium.</Text>
    </ScrollView>
  );
};
