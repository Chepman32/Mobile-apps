...
import { usePocketPolyglotRN } from '../context/PocketPolyglotRNContext';
...
export default function HomeScreen() {
  ...
  const { state, calculateStats } = usePocketPolyglotRN();
            ...
            <View style={styles.offlineStatus}>
              ...
              <View style={styles.offlineText}>
                ...
                <Text style={[styles.offlineDescription, { color: theme.colors.onSurfaceVariant }]}>
                  Access your saved translations and flashcards offline
                </Text>
              </View>
              <Button
                mode="outlined"
