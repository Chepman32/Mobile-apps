...
const SettingsScreen = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        { text: 'Reset', onPress: () => {
            ...
            Alert.alert('Data Reset', 'All learning data has been reset (conceptual).');
          }
        },
      ],
      { cancelable: true }
  ...
  const purchasePremium = () => {
    Alert.alert(
      ...
      'In a real app, this would initiate an in-app purchase for advanced analytics, custom reports, etc.'
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.settingButton} onPress={resetData}>
        <Text style={styles.settingButtonText}>Reset All Learning Data</Text>
      </TouchableOpacity>
